...
function NowPlaying() {
	...
	useEffect(() => {
		...
		return () =>
			music.instance.removeEventListener('mediaItemDidChange', handleChange);
	});
...
function Controls() {
	...
	useEffect(() => {
		...
		return () =>
			music.instance.removeEventListener('mediaCanPlay', handleChange);
	});
	...
	useEffect(() => {
		...
		return () =>
			music.player.removeEventListener('playbackStateDidChange', handleChange);
	});
